...
//    frame.setEnabled(!modal);
  ...
  private void naglData() {
    naglowek = new String[]{"Lp",
      ...
      "<html><center>ODP£YW 1<br/>Wartoœæ</center><html>",
      "<html><center>ODP£YW 2<br/>T/N</center><html>",
      "<html><center>ODP£YW 2<br/>Wartoœæ</center><html>",
      "Uwagi"};
    data = new Object[][]{
      ...
      {"2", "Inom", "Nastawa pr¹du znamionowego odp³ywu", "[A]", "X",
        ...
        "1-1000 A"},
      {"3", "Wsp.Zw.",
        "Nastawa zabezpieczenia zwarciowego - wspó³czynnik zwarcia", "[n/n]",
        "X",
        Boolean.FALSE, 0,
        Boolean.FALSE, 0,
        ""},
      {"4", "Zw.Zwlo", "Nastawa zabezpieczenia zwarciowego - Zw³oka zwarcia",
        ...
        ""},
      {"5", "Wsp.p./sf",
        "Nastawa wspó³czynnika przeci¹¿enia/Nastawa Serwis factor. Powi¹zane z opcj¹ wyboru sposobu dzia³ania zabezpieczenia przeci¹¿eniowego",
        "", "X",
        Boolean.FALSE, 0,
        Boolean.FALSE, 0,
        "Wybór wpó³czynnika przeci¹¿enia tylko wówczas gdy wybrano sposób dzia³ania  wg wspó³czynnika przeci¹¿enia.   Wybór wspó³czynnika Sf  gdy wybrano sposób dzia³ania wg charakterystyki"},
      {"6", "Przec.Zwl.",
        "Nastawa  zabezpieczenia przeci¹¿eniowego - Zw³oka zadzia³ania", "s",
        "X",
        Boolean.FALSE, 0,
        Boolean.FALSE, 0,
        "dzia³a tylko wówczas, gdy wybrano charakt. przeci¹¿enia wg wspó³czynnika przeci¹¿enia"},
      {"7", "Asymetria",
        "Nastawa zabezpieczenia asymetrowego wspó³czynnik asymetrii", "[%]", "X",
        Boolean.FALSE, 0,
        Boolean.FALSE, 0,
        ""},
      {"8", "Asym.Zwlo",
        ...
        ""},
      {"9", "Char.Przec.",
        "Wybór sposobu dzia³ania zabezpieczenia przeci¹¿eniowego ", "0-1", "X",
        Boolean.FALSE, Float.POSITIVE_INFINITY,
        Boolean.FALSE, Float.POSITIVE_INFINITY,
        "0- wg wspó³czynnika przeci¹¿enia, 1-wg charakterystyki"},
      {"10", "Przekr.P.",
        "Nastawa zabezpieczenia nadmiarowego - wartoœæ przekroczenia pr¹du",
        "[A]", "X",
        Boolean.FALSE, 0,
        Boolean.FALSE, 0,
        "Mo¿e byæ u¿ywana  dla sterowania silników dwubiegowych"},
      {"11", "PP.Zwloka",
        "Nastawa zabezpieczenia nadmiarowego - zw³oka zadzia³ania", "[s]", "X",
        Boolean.FALSE, 0,
        Boolean.FALSE, 0,
        ""},
      {"12", "Kom[0-3]", "wybór komunikatu jednego z trzech", "0-3",
        "Komunikat 1",
        Boolean.FALSE, Float.POSITIVE_INFINITY,
        Boolean.FALSE, Float.POSITIVE_INFINITY,
        ""},
      {"13", "Kom[0-3]", "wybór komunikatu jednego z trzech", "0-3",
        "Komunikat 2",
        Boolean.FALSE, Float.POSITIVE_INFINITY,
        Boolean.FALSE, Float.POSITIVE_INFINITY,
        ""},
      {"14", "Kom[0-3]", "wybór komunikatu jednego z trzech", "0-3",
        "Komunikat 3",
        Boolean.FALSE, Float.POSITIVE_INFINITY,
        Boolean.FALSE, Float.POSITIVE_INFINITY,
        ""},
      {"15", "Kom[0-3]", "wybór komunikatu jednego z trzech", "0-3",
        "Komunikat 4",
        Boolean.FALSE, Float.POSITIVE_INFINITY,
        Boolean.FALSE, Float.POSITIVE_INFINITY,
        ""},};
